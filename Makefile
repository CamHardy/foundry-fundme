...
DEFAULT_ANVIL_KEY := YOUR-KEY-HERE
...
# Remove modules
remove :; rm -rf .gitmodules && rm -rf .git/modules/* && rm -rf lib && touch .gitmodules && git add . && git commit -a "modules"
...
NETWORK_ARGS := --rpc-url https://localhost:8545 --private-key $(DEFAULT_ANVIL_KEY) --broadcast
